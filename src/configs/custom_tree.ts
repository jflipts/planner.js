...
import AvailablePublicTransportTilesFetcherTree from "../fetcher/publictransporttiles/AvailablePublicTransportTilesFetcherTree";
...
export default function getContainer(catalog: Catalog) {
  ...
  container.bind<IPublicTransportTilesProvider>(TYPES.PublicTransportTilesProvider)
    .to(AvailablePublicTransportTilesProviderTree).inSingletonScope();
  container.bind<IPublicTransportTilesFetcher>(TYPES.PublicTransportTilesFetcher)
    .to(AvailablePublicTransportTilesFetcherTree);
  container.bind<interfaces.Factory<IPublicTransportTilesFetcher>>(TYPES.PublicTransportTilesFetcherFactory)
    .toFactory<IPublicTransportTilesFetcher>(
      (context: interfaces.Context) =>
        (accessUrl: string) => {
          const fetcher =
            context.container.get<AvailablePublicTransportTilesFetcherTree>(TYPES.PublicTransportTilesFetcher);
          fetcher.setAccessUrl(accessUrl);
          return fetcher;
        },
    );
