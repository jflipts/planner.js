...
// @injectable()
export default class TileFetchStrategyLineIterator extends AsyncIterator<Set<IPublicTransportTile>> {
    ...
    public read(): Set<IPublicTransportTile> {
        if (this.closed) {
            return null;
        }
